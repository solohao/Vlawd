        ...
        <div className="flex-1 overflow-y-auto">
          <div className="mx-auto w-full max-w-[1400px] px-6 py-4">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-[1fr_360px]">
              <FeatureSection id="dashboard.voice" title="语音入口" className="h-full">
              ...
              <FeatureSection id="dashboard.status" title="运行状态" className="h-full">
            ...
            <FeatureSection id="dashboard.actions" title="常用操作" className="h-full">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
              <FeatureSection id="dashboard.current-task" title="当前任务" className="h-full">
                <CurrentTaskPanel onOpenSessions={onOpenSessions} />
              </FeatureSection>
              <FeatureSection id="dashboard.recent" title="最近使用" className="h-full">
